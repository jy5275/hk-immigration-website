      ...
      <div className="flex-grow flex flex-col min-h-0">
        ...
        <div className="flex-grow overflow-y-auto pr-2 border rounded-lg bg-gray-50">
          <div className="p-3 space-y-1.5">
            ...
            {["Lo Wu","Lok Ma Chau Spur Line","Airport","Shenzhen Bay","Hong Kong-Zhuhai-Macao Bridge","Express Rail Link West Kowloon","Heung Yuen Wai",
              "Lok Ma Chau","Macau Ferry Terminal","Man Kam To","China Ferry Terminal","Kai Tak Cruise Terminal","Harbour Control","Sha Tau Kok","Hung Hom","Tuen Mun Ferry Terminal"].map(point => (
